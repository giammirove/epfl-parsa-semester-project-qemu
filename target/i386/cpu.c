...
#define INTEL_PT_ADDR_RANGES_NUM                                               \
  0x2 /* Number of configurable address ranges                                 \
       */
...
#define PENTIUM_FEATURES                                                       \
  (I486_FEATURES | CPUID_DE | CPUID_TSC | CPUID_MSR | CPUID_MCE | CPUID_CX8 |  \
   CPUID_MMX | CPUID_APIC)
...
#define TCG_EXT_FEATURES                                                       \
  (CPUID_EXT_SSE3 | CPUID_EXT_PCLMULQDQ | CPUID_EXT_MONITOR |                  \
   ...
   CPUID_EXT_AVX | CPUID_EXT_F16C | CPUID_EXT_FMA | CPUID_EXT_X2APIC |         \
...
#define TCG_EXT3_FEATURES                                                      \
  (CPUID_EXT3_LAHF_LM | CPUID_EXT3_SVM | CPUID_EXT3_CR8LEG | CPUID_EXT3_ABM |  \
   CPUID_EXT3_SSE4A | CPUID_EXT3_3DNOWPREFETCH | CPUID_EXT3_KERNEL_FEATURES)
...
#define TCG_7_0_EBX_FEATURES                                                   \
  (CPUID_7_0_EBX_SMEP | CPUID_7_0_EBX_SMAP | CPUID_7_0_EBX_BMI1 |              \
   ...
   CPUID_7_0_EBX_RDSEED | CPUID_7_0_EBX_SHA_NI |                               \
...
FeatureWordInfo feature_word_info[FEATURE_WORDS] = {
    ...
    [FEAT_8000_0001_ECX] =
        {
            ...
            .feat_names =
                {
                    "lahf-lm",    "cmp-legacy",  "svm",
                    "extapic",    "cr8legacy",   "abm",
                    "sse4a",      "misalignsse", "3dnowprefetch",
                    "osvw",       "ibs",         "xop",
                    "skinit",     "wdt",         NULL,
                    "lwp",        "fma4",        "tce",
                    NULL,         "nodeid-msr",  NULL,
                    "tbm",        "topoext",     "perfctr-core",
                    "perfctr-nb", NULL,          NULL,
                    NULL,         NULL,          NULL,
                    NULL,         NULL,
                },
            .cpuid =
    ...
    [FEAT_C000_0001_EDX] =
        {
            ...
            .feat_names =
                {
                    NULL,  NULL,     "xstore",    "xstore-en", NULL,
                    NULL,  "xcrypt", "xcrypt-en", "ace2",      "ace2-en",
                    "phe", "phe-en", "pmm",       "pmm-en",    NULL,
    ...
    [FEAT_7_2_EDX] =
        {
            ...
            .feat_names =
                {
                    NULL, NULL, NULL, NULL, NULL, "mcdt-no", NULL, NULL,
    ...
    [FEAT_8000_0007_EDX] =
        {
            ...
            .feat_names =
                {
                    NULL,     NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    "invtsc", NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL,     NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL,     NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                },
            .cpuid =
            ...
            .feat_names =
                {
                    ...
                    "wbnoinvd",  NULL,        NULL,
                    "ibpb",      NULL,        "ibrs",
                    "amd-stibp", NULL,        "stibp-always-on",
                    NULL,        NULL,        NULL,
                    NULL,        NULL,        NULL,
                    "amd-ssbd",  "virt-ssbd", "amd-no-ssb",
                    NULL,        "amd-psfd",  NULL,
                    NULL,        NULL,
                },
            .cpuid =
    ...
    [FEAT_XSAVE] =
        {
            ...
            .feat_names =
                {
                    "xsaveopt", "xsavec", "xgetbv1", "xsaves", "xfd", NULL,
    ...
    [FEAT_6_EAX] =
        {
            ...
            .feat_names =
                {
                    NULL, NULL, "arat", NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL,   NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL,   NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL,   NULL, NULL, NULL, NULL, NULL,
                },
    ...
    [FEAT_CORE_CAPABILITY] =
        {
            ...
            .feat_names =
                {
                    NULL, NULL, NULL, NULL, NULL, "split-lock-detect",
                    NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL, NULL, NULL, NULL,
            ...
            .feat_names =
                {
                    ...
                    NULL, NULL, NULL, NULL, NULL, NULL, "full-width-write",
                    NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL, NULL,
                },
    ...
    [FEAT_VMX_PROCBASED_CTLS] = {.type = MSR_FEATURE_WORD,
                                 .feat_names =
                                     {
                                         NULL,
                                         NULL,
    ...
    [FEAT_VMX_SECONDARY_CTLS] = {.type = MSR_FEATURE_WORD,
                                 .feat_names =
                                     {
                                         "vmx-apicv-xapic",
                                         "vmx-ept",
    ...
    [FEAT_VMX_PINBASED_CTLS] = {.type = MSR_FEATURE_WORD,
                                .feat_names =
                                    {
                                        "vmx-intr-exit",
                                        NULL,
    ...
    [FEAT_VMX_ENTRY_CTLS] = {.type = MSR_FEATURE_WORD,
                             .feat_names =
                                 {
                                     NULL,
                                     NULL,
    ...
    [FEAT_VMX_MISC] = {.type = MSR_FEATURE_WORD,
                       .feat_names =
                           {
                               NULL,
                               NULL,
    ...
    [FEAT_VMX_EPT_VPID_CAPS] = {.type = MSR_FEATURE_WORD,
                                .feat_names =
                                    {
                                        "vmx-ept-execonly",
                                        NULL,
    ...
    [FEAT_VMX_BASIC] =
        {
            ...
            /* Just to be safe - we don't support setting the MSEG version
               field.  */
            .no_autoenable_flags = MSR_VMX_BASIC_DUAL_MONITOR,
        },

    [FEAT_VMX_VMFUNC] = {.type = MSR_FEATURE_WORD,
                         .feat_names =
                             {
            ...
            .feat_names =
                {
                    ...
                    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL, NULL, NULL, NULL, NULL, NULL, NULL, "intel-pt-lip",
                },
            .cpuid =
                {
                    .eax = 0x14,
    ...
    [FEAT_SGX_12_0_EAX] =
        {
            ...
            .feat_names =
                {
                    "sgx1", "sgx2", NULL, NULL, NULL,           NULL, NULL,
                    NULL,   NULL,   NULL, NULL, "sgx-edeccssa", NULL, NULL,
                    NULL,   NULL,   NULL, NULL, NULL,           NULL, NULL,
                    NULL,   NULL,   NULL, NULL, NULL,           NULL, NULL,
                    NULL,   NULL,   NULL, NULL,
                },
    ...
    [FEAT_SGX_12_0_EBX] =
        {
            ...
            .feat_names =
                {
                    "sgx-exinfo", NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL,         NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL,         NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                    NULL,         NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                },
...
ExtSaveArea x86_ext_save_areas[XSAVE_STATE_AREA_COUNT] = {
    ...
    [XSTATE_ARCH_LBR_BIT] = {.feature = FEAT_7_0_EDX,
                             .bits = CPUID_7_0_EDX_ARCH_LBR,
                             .offset =
    ...
    [XSTATE_XTILE_DATA_BIT] = {.feature = FEAT_7_0_EDX,
                               .bits = CPUID_7_0_EDX_AMX_TILE,
...
static const X86CPUDefinition builtin_x86_defs[] = {
    ...
    {.name = "phenom",
     ...
     .features[FEAT_1_ECX] =
         CPUID_EXT_SSE3 | CPUID_EXT_MONITOR | CPUID_EXT_CX16 | CPUID_EXT_POPCNT,
     .features[FEAT_8000_0001_EDX] =
         CPUID_EXT2_LM | CPUID_EXT2_SYSCALL | CPUID_EXT2_NX | CPUID_EXT2_3DNOW |
         ...
         (X86CPUVersionDefinition[]){
             ...
             {.version = 2,
              ...
              .props =
                  (PropValue[]){
                      {"spec-ctrl", "on"},
                      {"model-id", "Westmere E56xx/L56xx/X56xx (IBRS update)"},
                      {/* end of list */}}},
             {/* end of list */}}},
    {.name = "SandyBridge",
     .level = 0xd,
    ...
    {.name = "IvyBridge",
     ...
     .features[FEAT_1_EDX] = CPUID_VME | CPUID_SSE2 | CPUID_SSE | CPUID_FXSR |
                             ...
                             CPUID_MCE | CPUID_PAE | CPUID_MSR | CPUID_TSC |
                             CPUID_PSE | CPUID_DE | CPUID_FP87,
     .features[FEAT_1_ECX] = CPUID_EXT_AVX | CPUID_EXT_XSAVE | CPUID_EXT_AES |
                             CPUID_EXT_TSC_DEADLINE_TIMER | CPUID_EXT_POPCNT |
                             CPUID_EXT_X2APIC | CPUID_EXT_SSE42 |
                             CPUID_EXT_SSE41 | CPUID_EXT_CX16 |
         ...
         (X86CPUVersionDefinition[]){
             ...
             {.version = 2,
              ...
              .props =
                  (PropValue[]){
                      {"spec-ctrl", "on"},
                      {"model-id", "Intel Xeon E3-12xx v2 (Ivy Bridge, IBRS)"},
                      {/* end of list */}}},
             {/* end of list */}}},
    {.name = "Haswell",
     .level = 0xd,
     ...
     .features[FEAT_1_ECX] =
         ...
         CPUID_EXT_X2APIC | CPUID_EXT_SSE42 | CPUID_EXT_SSE41 | CPUID_EXT_CX16 |
    ...
    {.name = "SapphireRapids",
     ...
     .features[FEAT_7_0_EBX] =
         ...
         CPUID_7_0_EBX_AVX2 | CPUID_7_0_EBX_SMEP | CPUID_7_0_EBX_BMI2 |
         CPUID_7_0_EBX_ERMS | CPUID_7_0_EBX_INVPCID | CPUID_7_0_EBX_RTM |
         CPUID_7_0_EBX_AVX512F | CPUID_7_0_EBX_AVX512DQ | CPUID_7_0_EBX_RDSEED |
     ...
     .features[FEAT_VMX_EXIT_CTLS] =
         ...
         VMX_VM_EXIT_LOAD_IA32_PERF_GLOBAL_CTRL | VMX_VM_EXIT_ACK_INTR_ON_EXIT |
         VMX_VM_EXIT_SAVE_IA32_PAT | VMX_VM_EXIT_LOAD_IA32_PAT |
         VMX_VM_EXIT_SAVE_IA32_EFER | VMX_VM_EXIT_LOAD_IA32_EFER |
     ...
     .features[FEAT_VMX_SECONDARY_CTLS] =
         ...
         VMX_SECONDARY_EXEC_RDTSCP | VMX_SECONDARY_EXEC_VIRTUALIZE_X2APIC_MODE |
     ...
     .versions =
         (X86CPUVersionDefinition[]){
             ...
             {.version = 2,
              ...
              .props =
                  (PropValue[]){{"ibpb", "on"},
                                {"model-id", "AMD EPYC Processor (with IBPB)"},
                                {/* end of list */}}},
             {.version = 3,
         ...
         (X86CPUVersionDefinition[]){
             ...
             {.version = 2,
              .props = (PropValue[]){{"ibrs", "on"},
                                     ...
                                     {/* end of list */}}},
             {.version = 3,
              .props = (PropValue[]){{"model-id", "AMD EPYC-Rome-v3 Processor"},
                                     {/* end of list */}},
    ...
    {.name = "EPYC-Milan",
     ...
     .versions =
         (X86CPUVersionDefinition[]){
             ...
             {.version = 2,
              .props =
                  (PropValue[]){{"model-id", "AMD EPYC-Milan-v2 Processor"},
                                {"vaes", "on"},
                                {"vpclmulqdq", "on"},
                                {"stibp-always-on", "on"},
                                {"amd-psfd", "on"},
...
{
  int v = 0;
  const X86CPUVersionDefinition *vdef = x86_cpu_def_get_versions(model->cpudef);
  while (vdef->version) {
    v = vdef->version;
    vdef++;
  }
                                         ...
                                         Error **errp)
{
  ...
  if (value < min || value > max) {
    error_setg(errp, QERR_PROPERTY_VALUE_OUT_OF_RANGE, "", name ? name : "null",
               value, min, max);
    return;
  }
                                     ...
                                     Error **errp)
{
  ...
  for (featurestr = strtok(features, ","); featurestr;
    ...
    if (featurestr[0] == '+') {
      plus_features = g_list_append(plus_features, g_strdup(featurestr + 1));
      continue;
    }
    else if (featurestr[0] == '-') {
      minus_features = g_list_append(minus_features, g_strdup(featurestr + 1));
      continue;
    }
...
uint64_t x86_cpu_get_supported_feature_word(FeatureWord w, bool migratable_only)
{
  ...
  if (kvm_enabled()) {
    switch (wi->type) {
    case CPUID_FEATURE_WORD:
      r = kvm_arch_get_supported_cpuid(kvm_state, wi->cpuid.eax, wi->cpuid.ecx,
                                       wi->cpuid.reg);
      break;
    case MSR_FEATURE_WORD:
    ...
    r = hvf_get_supported_cpuid(wi->cpuid.eax, wi->cpuid.ecx, wi->cpuid.reg);
  }
  else if (tcg_enabled()) {
    r = wi->tcg_features;
  }
...
static void x86_register_cpudef_types(const X86CPUDefinition *def)
{
  ...
  for (vdef = x86_cpu_def_get_versions(def); vdef->version; vdef++) {
    g_autofree char *name = x86_cpu_versioned_model_name(def, vdef->version);
                   ...
                   uint32_t *eax, uint32_t *ebx, uint32_t *ecx, uint32_t *edx)
{
    ...
    if (cpu->cache_info_passthrough) {
      ...
      *eax = 0;
      ...
      case 0: /* L1 dcache info */
        encode_cache_cpuid4(env->cache_info_cpuid4.l1d_cache, 1, cs->nr_cores,
                            eax, ebx, ecx, edx);
        break;
      case 1: /* L1 icache info */
        encode_cache_cpuid4(env->cache_info_cpuid4.l1i_cache, 1, cs->nr_cores,
                            eax, ebx, ecx, edx);
        break;
      case 2: /* L2 cache info */
        encode_cache_cpuid4(env->cache_info_cpuid4.l2_cache, cs->nr_threads,
      ...
      case 3: /* L3 cache info */
        ...
        if (cpu->enable_l3_cache) {
          encode_cache_cpuid4(env->cache_info_cpuid4.l3_cache,
                              (1 << die_offset), cs->nr_cores, eax, ebx, ecx,
                              edx);
          break;
        }
        /* fall through */
  ...
  case 7:
    ...
    if (count == 0) {
      ...
      *edx = env->features[FEAT_7_0_EDX]; /* Feature flags */
       ...
       */
      x86_cpu_get_supported_cpuid(0x7, 0, &eax_0_unused, &ebx_0, &ecx_0,
                                  &edx_0_unused);
    ...
    if (count == 0) {
      ...
      *edx = env->features[FEAT_XSAVE_XSS_HI];
      ...
      if (x86_cpu_xsave_xcr0_components(cpu) & (1ULL << count)) {
        *eax = esa->size;
        *ebx = esa->offset;
        *ecx = esa->ecx & (ESA_FEATURE_ALIGN64_MASK | ESA_FEATURE_XFD_MASK);
      }
  ...
  case 0x12:
#ifndef CONFIG_USER_ONLY
    if (!kvm_enabled() || !(env->features[FEAT_7_0_EBX] & CPUID_7_0_EBX_SGX)) {
      *eax = *ebx = *ecx = *edx = 0;
      break;
    }
    ...
    if (count == 0) {
      ...
      *ecx |= XSTATE_FP_MASK | XSTATE_SSE_MASK;
      ...
      if ((*eax & (1U << 4)) && !kvm_enable_sgx_provisioning(cs->kvm_state)) {
        *eax &= ~(1U << 4);
      }
    }
#endif
  ...
  case 0x1D: {
    ...
    *edx = 0;
    ...
    if (count == 0) {
      ...
      *eax = INTEL_AMX_TOTAL_TILE_BYTES | (INTEL_AMX_BYTES_PER_TILE << 16);
  ...
  case 0x8000001D:
    *eax = 0;
    ...
    switch (count) {
    case 0: /* L1 dcache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l1d_cache, &topo_info, eax,
                                 ebx, ecx, edx);
      break;
    case 1: /* L1 icache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l1i_cache, &topo_info, eax,
                                 ebx, ecx, edx);
      break;
    case 2: /* L2 cache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l2_cache, &topo_info, eax,
                                 ebx, ecx, edx);
      break;
    case 3: /* L3 cache info */
      encode_cache_cpuid8000001d(env->cache_info_amd.l3_cache, &topo_info, eax,
                                 ebx, ecx, edx);
      break;
    default: /* end of info */
      *eax = *ebx = *ecx = *edx = 0;
...
void x86_cpu_expand_features(X86CPU *cpu, Error **errp)
{
  ...
  if (cpu->full_cpuid_auto_level) {
    ...
    if ((env->features[FEAT_7_0_EBX] & CPUID_7_0_EBX_INTEL_PT)) {
      if (cpu->intel_pt_auto_level) {
        ...
        mark_unavailable_features(cpu, FEAT_7_0_EBX, CPUID_7_0_EBX_INTEL_PT,
                                  "Intel PT need CPUID leaf 0x14, please set "
                                  "by \"-cpu ...,intel-pt=on,min-level=0x14\"");
      }
    }
     ...
     * machine types.
     */
    if ((env->nr_dies > 1) && (IS_INTEL_CPU(env) || !cpu->vendor_cpuid_only)) {
...
static void x86_cpu_filter_features(X86CPU *cpu, bool verbose)
{
  ...
  if (verbose) {
    prefix = accel_uses_host_cpuid() ? "host doesn't support requested feature"
  ...
  if ((env->features[FEAT_7_0_EBX] & CPUID_7_0_EBX_INTEL_PT) && kvm_enabled()) {
    ...
    x86_cpu_get_supported_cpuid(0x14, 0, &eax_0, &ebx_0, &ecx_0, &edx_0_unused);
    x86_cpu_get_supported_cpuid(0x14, 1, &eax_1, &ebx_1, &ecx_1_unused,
                                &edx_1_unused);

    if (!eax_0 || ((ebx_0 & INTEL_PT_MINIMAL_EBX) != INTEL_PT_MINIMAL_EBX) ||
        ((ecx_0 & INTEL_PT_MINIMAL_ECX) != INTEL_PT_MINIMAL_ECX) ||
        ((eax_1 & INTEL_PT_MTC_BITMAP) != INTEL_PT_MTC_BITMAP) ||
        ((eax_1 & INTEL_PT_ADDR_RANGES_NUM_MASK) < INTEL_PT_ADDR_RANGES_NUM) ||
...
static void x86_cpu_realizefn(DeviceState *dev, Error **errp)
{
   ...
   */
  requested_lbr_fmt = env->features[FEAT_PERF_CAPABILITIES] & PERF_CAP_LBR_FMT;
  ...
  if (env->features[FEAT_8000_0001_EDX] & CPUID_EXT2_LM) {
    if (cpu->phys_bits &&
        (cpu->phys_bits > TARGET_PHYS_ADDR_SPACE_BITS || cpu->phys_bits < 32)) {
      error_setg(errp,
...
int x86_cpu_pending_interrupt(CPUState *cs, int interrupt_request)
{
  ...
  if (env->hflags2 & HF2_GIF_MASK) {
    if ((interrupt_request & CPU_INTERRUPT_SMI) &&
      ...
      if ((interrupt_request & CPU_INTERRUPT_VIRQ) && (env->eflags & IF_MASK) &&
          !(env->hflags & HF_INHIBIT_IRQ_MASK)) {
...
static int x86_cpu_mmu_index(CPUState *cs, bool ifetch)
{
  ...
  int mmu_index_base = (env->hflags & HF_CPL_MASK) == 3 ? MMU_USER64_IDX
                       : !(env->hflags & HF_SMAP_MASK)  ? MMU_KNOSMAP64_IDX
                       : (env->eflags & AC_MASK)        ? MMU_KNOSMAP64_IDX
                                                        : MMU_KSMAP64_IDX;
...
#define HFLAG_COPY_MASK                                                        \
  ...
  if ((hflags & HF_LMA_MASK) && (env->segs[R_CS].flags & DESC_L_MASK)) {
    ...
    hflags |=
        (env->segs[R_CS].flags & DESC_B_MASK) >> (DESC_B_SHIFT - HF_CS32_SHIFT);
    hflags |=
...
static void x86_cpu_common_class_init(ObjectClass *oc, void *data)
{
  ...
  object_class_property_add(oc, "tsc-frequency", "int", x86_cpuid_get_tsc_freq,
  ...
  object_class_property_add(oc, "unavailable-features", "strList",
                            x86_cpu_get_unavailable_features, NULL, NULL, NULL);
