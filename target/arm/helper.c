...
static void pmccntr_op_start(CPUARMState *env)
{
  ...
  if (pmu_counter_enabled(env, 31)) {
    ...
    uint64_t overflow_mask =
        env->cp15.c9_pmcr & PMCRLC ? 1ull << 63 : 1ull << 31;
...
static void pmccntr_op_finish(CPUARMState *env)
{
  if (pmu_counter_enabled(env, 31)) {
    ...
    if (overflow_in > 0) {
      ...
      if (!sadd64_overflow(qemu_clock_get_ns(QEMU_CLOCK_VIRTUAL), overflow_in,
                           &overflow_at)) {
        ARMCPU *cpu = env_archcpu(env);
                                ...
                                uint64_t value)
{
  ...
  env->cp15.pmccfiltr_el0 =
      (env->cp15.pmccfiltr_el0 & PMCCFILTR_M) | (value & PMCCFILTR);
  pmccntr_op_finish(env);
}
...
static uint64_t ccsidr_read(CPUARMState *env, const ARMCPRegInfo *ri)
{
   ...
   */
  uint32_t index =
      A32_BANKED_REG_GET(env, csselr, ri->secure & ARM_CP_SECSTATE_S);
                                        ...
                                        bool isread)
{
  ...
  case 1:
    ...
    if (has_el2 && timeridx == GTIMER_PHYS &&
        (hcr & HCR_E2H ? !extract32(env->cp15.cnthctl_el2, 10, 1)
...
static CPAccessResult gt_pct_access(CPUARMState *env, const ARMCPRegInfo *ri,
                                    bool isread)
{
  return gt_counter_access(env, GTIMER_PHYS, isread);
}

static CPAccessResult gt_vct_access(CPUARMState *env, const ARMCPRegInfo *ri,
                                    bool isread)
{
...
static CPAccessResult gt_stimer_access(CPUARMState *env, const ARMCPRegInfo *ri,
                                       bool isread)
{
  /*
...
static void gt_recalc_timer(ARMCPU *cpu, int timeridx)
{
  ...
  if (gt->ctl & 1) {
    ...
    uint64_t offset = timeridx == GTIMER_VIRT
                          ...
                          : gt_phys_raw_cnt_offset(&cpu->env);
...
static void gt_ctl_write(CPUARMState *env, const ARMCPRegInfo *ri, int timeridx,
                         uint64_t value)
{
  ARMCPU *cpu = env_archcpu(env);
                             ...
                             uint64_t value)
{
  ...
  uint32_t valid_mask = R_CNTHCTL_EL0PCTEN_E2H1_MASK |
                        R_CNTHCTL_EL0VCTEN_E2H1_MASK | R_CNTHCTL_EVNTEN_MASK |
                        R_CNTHCTL_EVNTDIR_MASK | R_CNTHCTL_EVNTI_MASK |
                        R_CNTHCTL_EL0VTEN_MASK | R_CNTHCTL_EL0PTEN_MASK |
                        R_CNTHCTL_EL1PCTEN_E2H1_MASK | R_CNTHCTL_EL1PTEN_MASK;

  if (cpu_isar_feature(aa64_rme, cpu)) {
    valid_mask |= R_CNTHCTL_CNTVMASK_MASK | R_CNTHCTL_CNTPMASK_MASK;
  }
  if (cpu_isar_feature(aa64_ecv_traps, cpu)) {
    valid_mask |= R_CNTHCTL_EL1TVT_MASK | R_CNTHCTL_EL1TVCT_MASK |
                  R_CNTHCTL_EL1NVPCT_MASK | R_CNTHCTL_EL1NVVCT_MASK |
...
static const ARMCPRegInfo generic_timer_cp_reginfo[] = {
    ...
    /* per-timer control */
    {
        ...
        .fieldoffset =
            offsetoflow32(CPUARMState, cp15.c14_timer[GTIMER_PHYS].ctl),
    ...
    },
    {
        ...
        .accessfn = gt_ptimer_access,
        .fieldoffset =
            offsetoflow32(CPUARMState, cp15.c14_timer[GTIMER_SEC].ctl),
    ...
    },
    {
        ...
        .fieldoffset =
            offsetoflow32(CPUARMState, cp15.c14_timer[GTIMER_VIRT].ctl),
...
static int par_el1_shareability(GetPhysAddrResult *res)
{
   ...
   */
  if (((res->cacheattrs.attrs & 0xf0) == 0) || res->cacheattrs.attrs == 0x44 ||
      res->cacheattrs.attrs == 0x40) {
    return 2;
  }
                             ...
                             ARMSecuritySpace ss)
{
  ...
  if (ret) {
    ...
    if (take_exc) {
       ...
       */
      syn = syn_data_abort_no_iss(current_el == target_el, 0, fi.ea, 1,
                                  fi.s1ptw, 1, fsc);
                        ...
                        uint64_t value)
{
  ...
  par64 = do_ats_write(env, value, access_type, ARMMMUIdx_E2, ARMSS_NonSecure);
                        ...
                        uint64_t value)
{
  ...
  case 0:
    ...
    case 0: /* AT S1E1R, AT S1E1W, AT S1E1RP, AT S1E1WP */
      if (ri->crm == 9 && arm_pan_enabled(env)) {
        mmu_idx = regime_e20 ? ARMMMUIdx_E20_2_PAN : ARMMMUIdx_Stage1_E1_PAN;
      }
      else {
  ...
  env->cp15.par_el[1] =
      do_ats_write(env, value, access_type, mmu_idx, arm_security_space(env));
#else
  /* Handled by hardware accelerator. */
  g_assert_not_reached();
#endif /* CONFIG_TCG */
...
static const ARMCPRegInfo pmsav5_cp_reginfo[] = {
    ...
    },
    {
        ...
        .opc2 = 0,
        .access = PL1_RW,
        .fieldoffset = offsetof(CPUARMState, cp15.c2_data),
        .resetvalue = 0,
    },
    {
        .name = "ICACHE_CFG",
        ...
        .opc2 = 1,
        .access = PL1_RW,
        .fieldoffset = offsetof(CPUARMState, cp15.c2_insn),
        .resetvalue = 0,
    },
...
static const ARMCPRegInfo xscale_cp_reginfo[] = {
    {
        ...
        .opc2 = 0,
        .access = PL1_RW,
        .fieldoffset = offsetof(CPUARMState, cp15.c15_cpar),
        .resetvalue = 0,
...
static CPAccessResult
aa64_cacheop_poc_access(CPUARMState *env, const ARMCPRegInfo *ri, bool isread)
{
...
static int vae1_tlbmask(CPUARMState *env)
{
  ...
  if ((hcr & (HCR_E2H | HCR_TGE)) == (HCR_E2H | HCR_TGE)) {
    mask = ARMMMUIdxBit_E20_2 | ARMMMUIdxBit_E20_2_PAN | ARMMMUIdxBit_E20_0;
  }
  else {
    mask = ARMMMUIdxBit_E10_1 | ARMMMUIdxBit_E10_1_PAN | ARMMMUIdxBit_E10_0;
  }
  return mask;
}
                                   ...
                                   uint64_t value)
{
  ...
  tlb_flush_page_bits_by_mmuidx_all_cpus_synced(cs, pageaddr, ARMMMUIdxBit_E3,
                                                bits);
}
...
static int ipas2e1_tlbmask(CPUARMState *env, int64_t value)
{
   ...
   */
  return (value >= 0 && cpu_isar_feature(aa64_sel2, env_archcpu(env)) &&
                  arm_is_secure_below_el3(env)
...
static void do_rvae_write(CPUARMState *env, uint64_t value, int idxmap,
                          bool synced)
{
  ...
  if (synced) {
    tlb_flush_range_by_mmuidx_all_cpus_synced(env_cpu(env), range.base,
                                              range.length, idxmap, bits);
  }
  else {
    tlb_flush_range_by_mmuidx(env_cpu(env), range.base, range.length, idxmap,
                              bits);
  }
}
...
static void tlbi_aa64_ripas2e1is_write(CPUARMState *env, const ARMCPRegInfo *ri,
                                       uint64_t value)
{
...
uint64_t arm_hcr_el2_eff_secstate(CPUARMState *env, ARMSecuritySpace space)
{
  ...
  if (ret & HCR_TGE) {
    /* These bits are up-to-date as of ARMv8.6.  */
    if (ret & HCR_E2H) {
      ret &= ~(HCR_VM | HCR_FMO | HCR_IMO | HCR_AMO | HCR_BSU_MASK | HCR_DC |
               HCR_TWI | HCR_TWE | HCR_TID0 | HCR_TID2 | HCR_TPCP | HCR_TPU |
               HCR_TDZ | HCR_CD | HCR_ID | HCR_MIOCNCE | HCR_TID4 | HCR_TICAB |
               HCR_TOCU | HCR_ENSCXT | HCR_TTLBIS | HCR_TTLBOS | HCR_TID5);
    }
    else {
      ret |= HCR_FMO | HCR_IMO | HCR_AMO;
    }
    ret &= ~(HCR_SWIO | HCR_PTW | HCR_VF | HCR_VI | HCR_VSE | HCR_FB |
             HCR_TID1 | HCR_TID3 | HCR_TSC | HCR_TACR | HCR_TSW | HCR_TTLB |
             HCR_TVM | HCR_HCD | HCR_TRVM | HCR_TLOR);
  }
...
static const ARMCPRegInfo el2_cp_reginfo[] = {
    ...
    {.name = "TLBI_ALLE2",
     ...
     .opc2 = 0,
     .access = PL2_W,
     .type = ARM_CP_NO_RAW | ARM_CP_EL3_NO_EL2_UNDEF,
...
#define K(op0, op1, crn, crm, op2)                                             \
  ...
  static const struct E2HAlias aliases[] = {
      {K(3, 0, 1, 0, 0), K(3, 4, 1, 0, 0), K(3, 5, 1, 0, 0), "SCTLR",
       "SCTLR_EL2", "SCTLR_EL12"},
      {K(3, 0, 1, 0, 2), K(3, 4, 1, 1, 2), K(3, 5, 1, 0, 2), "CPACR",
       "CPTR_EL2", "CPACR_EL12"},
      {K(3, 0, 2, 0, 0), K(3, 4, 2, 0, 0), K(3, 5, 2, 0, 0), "TTBR0_EL1",
       "TTBR0_EL2", "TTBR0_EL12"},
      {K(3, 0, 2, 0, 1), K(3, 4, 2, 0, 1), K(3, 5, 2, 0, 1), "TTBR1_EL1",
       "TTBR1_EL2", "TTBR1_EL12"},
      {K(3, 0, 2, 0, 2), K(3, 4, 2, 0, 2), K(3, 5, 2, 0, 2), "TCR_EL1",
       "TCR_EL2", "TCR_EL12"},
      {K(3, 0, 4, 0, 0), K(3, 4, 4, 0, 0), K(3, 5, 4, 0, 0), "SPSR_EL1",
       "SPSR_EL2", "SPSR_EL12"},
      {K(3, 0, 4, 0, 1), K(3, 4, 4, 0, 1), K(3, 5, 4, 0, 1), "ELR_EL1",
       "ELR_EL2", "ELR_EL12"},
      {K(3, 0, 5, 1, 0), K(3, 4, 5, 1, 0), K(3, 5, 5, 1, 0), "AFSR0_EL1",
       "AFSR0_EL2", "AFSR0_EL12"},
      {K(3, 0, 5, 1, 1), K(3, 4, 5, 1, 1), K(3, 5, 5, 1, 1), "AFSR1_EL1",
       "AFSR1_EL2", "AFSR1_EL12"},
      {K(3, 0, 5, 2, 0), K(3, 4, 5, 2, 0), K(3, 5, 5, 2, 0), "ESR_EL1",
       "ESR_EL2", "ESR_EL12"},
      {K(3, 0, 6, 0, 0), K(3, 4, 6, 0, 0), K(3, 5, 6, 0, 0), "FAR_EL1",
       "FAR_EL2", "FAR_EL12"},
      {K(3, 0, 10, 2, 0), K(3, 4, 10, 2, 0), K(3, 5, 10, 2, 0), "MAIR_EL1",
       "MAIR_EL2", "MAIR_EL12"},
      {K(3, 0, 10, 3, 0), K(3, 4, 10, 3, 0), K(3, 5, 10, 3, 0), "AMAIR0",
       "AMAIR_EL2", "AMAIR_EL12"},
      {K(3, 0, 12, 0, 0), K(3, 4, 12, 0, 0), K(3, 5, 12, 0, 0), "VBAR",
       "VBAR_EL2", "VBAR_EL12"},
      {K(3, 0, 13, 0, 1), K(3, 4, 13, 0, 1), K(3, 5, 13, 0, 1),
       "CONTEXTIDR_EL1", "CONTEXTIDR_EL2", "CONTEXTIDR_EL12"},
      {K(3, 0, 14, 1, 0), K(3, 4, 14, 1, 0), K(3, 5, 14, 1, 0), "CNTKCTL",
       "CNTHCTL_EL2", "CNTKCTL_EL12"},
       ...
       */
      {K(3, 0, 1, 2, 0), K(3, 4, 1, 2, 0), K(3, 5, 1, 2, 0), "ZCR_EL1",
       "ZCR_EL2", "ZCR_EL12", isar_feature_aa64_sve},
      {K(3, 0, 1, 2, 6), K(3, 4, 1, 2, 6), K(3, 5, 1, 2, 6), "SMCR_EL1",
       "SMCR_EL2", "SMCR_EL12", isar_feature_aa64_sme},

      {K(3, 0, 5, 6, 0), K(3, 4, 5, 6, 0), K(3, 5, 5, 6, 0), "TFSR_EL1",
       "TFSR_EL2", "TFSR_EL12", isar_feature_aa64_mte},

      {K(3, 0, 13, 0, 7), K(3, 4, 13, 0, 7), K(3, 5, 13, 0, 7), "SCXTNUM_EL1",
       "SCXTNUM_EL2", "SCXTNUM_EL12", isar_feature_aa64_scxtnum},
...
#undef K
  ...
  for (i = 0; i < ARRAY_SIZE(aliases); i++) {
    ...
    src_reg =
        g_hash_table_lookup(cpu->cp_regs, (gpointer)(uintptr_t)a->src_key);
    dst_reg =
        g_hash_table_lookup(cpu->cp_regs, (gpointer)(uintptr_t)a->dst_key);
    ...
    ok = g_hash_table_insert(cpu->cp_regs, (gpointer)(uintptr_t)a->new_key,
                             new_reg);
    g_assert(ok);
...
static void svcr_write(CPUARMState *env, const ARMCPRegInfo *ri, uint64_t value)
{
                        ...
                        uint64_t value)
{
  ...
  uint64_t rw_mask = R_GPCCR_PPS_MASK | R_GPCCR_IRGN_MASK | R_GPCCR_ORGN_MASK |
                     R_GPCCR_SH_MASK | R_GPCCR_PGS_MASK | R_GPCCR_GPC_MASK |
                     R_GPCCR_GPCP_MASK;
...
{
  env->cp15.gpccr_el3 =
      FIELD_DP64(0, GPCCR, L0GPTSZ, env_archcpu(env)->reset_l0gptsz);
}
                                   ...
                                   bool isread)
{
  ...
  if (el < 2 && arm_is_el2_enabled(env) && !(arm_hcr_el2_eff(env) & HCR_APK)) {
    return CP_ACCESS_TRAP_EL2;
  }
  if (el < 3 && arm_feature(env, ARM_FEATURE_EL3) &&
...
static uint64_t rndr_readfn(CPUARMState *env, const ARMCPRegInfo *ri)
{
  ...
  if (qemu_guest_getrandom(&ret, sizeof(ret), &err) < 0) {
     ...
     */
    qemu_log_mask(LOG_UNIMP, "%s: Crypto failure: %s", ri->name,
                                        ...
                                        const ARMCPRegInfo *ri, bool isread)
{
  ...
  if (!arm_feature(env, ARM_FEATURE_V8) && arm_current_el(env) < 2 &&
      !arm_is_secure_below_el3(env) && (env->cp15.hstr_el2 & HSTR_TJDBX)) {
    return CP_ACCESS_TRAP_EL2;
  }
  return CP_ACCESS_OK;
}
...
void register_cp_regs_for_features(ARMCPU *cpu)
{
  ...
  if (arm_feature(env, ARM_FEATURE_V8)) {
    ...
    ARMCPRegInfo v8_idregs[] = {
        ...
        {.name = "ID_AA64MMFR3_EL1_RESERVED",
         .state = ARM_CP_STATE_AA64,
         .opc0 = 3,
         .opc1 = 0,
         .crn = 0,
    ...
    static const ARMCPRegUserSpaceInfo v8_user_idregs[] = {
        ...
        {.name = "ID_AA64PFR*_EL1_RESERVED", .is_glob = true},
        {.name = "ID_AA64ZFR0_EL1",
        ...
        {.name = "ID_AA64MMFR*_EL1_RESERVED", .is_glob = true},
        {.name = "ID_AA64DFR0_EL1",
         .fixed_bits = (0x6u << R_ID_AA64DFR0_DEBUGVER_SHIFT)},
        {.name = "ID_AA64DFR1_EL1"},
        {.name = "ID_AA64DFR*_EL1_RESERVED", .is_glob = true},
        {.name = "ID_AA64AFR*", .is_glob = true},
        {.name = "ID_AA64ISAR0_EL1",
        ...
        {.name = "ID_AA64ISAR*_EL1_RESERVED", .is_glob = true},
    };
                                   ...
                                   int opc2, const char *name)
{
  ...
  *r2 = *r;
  ...
  if (((r->crm == CP_ANY) && crm != 0) || ((r->opc1 == CP_ANY) && opc1 != 0) ||
                ...
                CPSRWriteType write_type)
{
  ...
  bool rebuild_hflags =
      (write_type != CPSRWriteRaw) && (mask & (CPSR_M | CPSR_E | CPSR_IL));
...
void aarch64_sync_64_to_32(CPUARMState *env) { g_assert_not_reached(); }
  ...
  if (env->exception.target_el == 2) {
    ...
    case EC_VECTORCATCH:
      env->exception.syndrome =
          syn_insn_abort(arm_current_el(env) == 2, 0, 0, 0x22);
      break;
    case EC_WATCHPOINT:
      env->exception.syndrome =
          syn_set_ec(env->exception.syndrome, EC_DATAABORT);
      break;
    case EC_WATCHPOINT_SAME_EL:
      env->exception.syndrome =
          syn_set_ec(env->exception.syndrome, EC_DATAABORT_SAME_EL);
      break;
    }
...
void arm_cpu_do_interrupt(CPUState *cs)
{
  ...
  if (qemu_loglevel_mask(CPU_LOG_INT) &&
    ...
    qemu_log_mask(CPU_LOG_INT, "...with ESR 0x%x/0x%" PRIx32 "\n",
                  syn_get_ec(env->exception.syndrome), env->exception.syndrome);
  }
