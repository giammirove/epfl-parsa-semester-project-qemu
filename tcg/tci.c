...
static void tci_args_nl(uint32_t insn, const void *tb_ptr, uint8_t *n0,
                        void **l1)
{
...
static void tci_args_rl(uint32_t insn, const void *tb_ptr, TCGReg *r0,
                        void **l1)
{
  *r0 = extract32(insn, 8, 4);
  *l1 = sextract32(insn, 12, 20) + (void *)tb_ptr;
...
static void tci_args_rrbb(uint32_t insn, TCGReg *r0, TCGReg *r1, uint8_t *i2,
                          uint8_t *i3)
{
  *r0 = extract32(insn, 8, 4);
  *r1 = extract32(insn, 12, 4);
...
static void tci_args_rrrc(uint32_t insn, TCGReg *r0, TCGReg *r1, TCGReg *r2,
                          TCGCond *c3)
{
  *r0 = extract32(insn, 8, 4);
  *r1 = extract32(insn, 12, 4);
...
static void tci_args_rrrbb(uint32_t insn, TCGReg *r0, TCGReg *r1, TCGReg *r2,
                           uint8_t *i3, uint8_t *i4)
{
  *r0 = extract32(insn, 8, 4);
  *r1 = extract32(insn, 12, 4);
  *r2 = extract32(insn, 16, 4);
...
static void tci_args_rrrrr(uint32_t insn, TCGReg *r0, TCGReg *r1, TCGReg *r2,
                           TCGReg *r3, TCGReg *r4)
{
  *r0 = extract32(insn, 8, 4);
  *r1 = extract32(insn, 12, 4);
...
static void tci_args_rrrr(uint32_t insn, TCGReg *r0, TCGReg *r1, TCGReg *r2,
                          TCGReg *r3)
{
  *r0 = extract32(insn, 8, 4);
  *r1 = extract32(insn, 12, 4);
...
static void tci_args_rrrrrc(uint32_t insn, TCGReg *r0, TCGReg *r1, TCGReg *r2,
...
static void tci_args_rrrrrr(uint32_t insn, TCGReg *r0, TCGReg *r1, TCGReg *r2,
...
static uint64_t tci_qemu_ld(CPUArchState *env, uint64_t taddr, MemOpIdx oi,
                            const void *tb_ptr)
{
...
#define CASE_64(x) case glue(glue(INDEX_op_, x), _i64):
#else
#define CASE_32_64(x) case glue(glue(INDEX_op_, x), _i32):
#define CASE_64(x)
#endif
...
int print_insn_tci(bfd_vma addr, disassemble_info *info)
{
  ...
  case INDEX_op_brcond_i64:
    tci_args_rl(insn, tb_ptr, &r0, &ptr);
    info->fprintf_func(info->stream, "%-12s  %s, 0, ne, %p", op_name, str_r(r0),
                       ptr);
    break;
  ...
  case INDEX_op_setcond_i64:
    ...
    info->fprintf_func(info->stream, "%-12s  %s, %s, %s, %s", op_name,
                       str_r(r0), str_r(r1), str_r(r2), str_c(c));
    break;

  case INDEX_op_tci_movi:
    tci_args_ri(insn, &r0, &i1);
    info->fprintf_func(info->stream, "%-12s  %s, 0x%" TCG_PRIlx, op_name,
                       str_r(r0), i1);
    break;
  ...
  case INDEX_op_st_i64:
    ...
    info->fprintf_func(info->stream, "%-12s  %s, %s, %d", op_name, str_r(r0),
                       str_r(r1), s2);
    break;
  ...
  case INDEX_op_ctpop_i64:
    tci_args_rr(insn, &r0, &r1);
    info->fprintf_func(info->stream, "%-12s  %s, %s", op_name, str_r(r0),
                       str_r(r1));
    break;
  ...
  case INDEX_op_ctz_i64:
    tci_args_rrr(insn, &r0, &r1, &r2);
    info->fprintf_func(info->stream, "%-12s  %s, %s, %s", op_name, str_r(r0),
                       str_r(r1), str_r(r2));
    break;
  ...
  case INDEX_op_deposit_i64:
    tci_args_rrrbb(insn, &r0, &r1, &r2, &pos, &len);
    info->fprintf_func(info->stream, "%-12s  %s, %s, %s, %d, %d", op_name,
                       str_r(r0), str_r(r1), str_r(r2), pos, len);
    break;
  ...
  case INDEX_op_sextract_i64:
    tci_args_rrbb(insn, &r0, &r1, &pos, &len);
    info->fprintf_func(info->stream, "%-12s  %s,%s,%d,%d", op_name, str_r(r0),
                       str_r(r1), pos, len);
    break;
  ...
  case INDEX_op_setcond2_i32:
    ...
    info->fprintf_func(info->stream, "%-12s  %s, %s, %s, %s, %s, %s", op_name,
                       str_r(r0), str_r(r1), str_r(r2), str_r(r3), str_r(r4),
                       str_c(c));
    break;
  ...
  case INDEX_op_muls2_i64:
    tci_args_rrrr(insn, &r0, &r1, &r2, &r3);
    info->fprintf_func(info->stream, "%-12s  %s, %s, %s, %s", op_name,
                       str_r(r0), str_r(r1), str_r(r2), str_r(r3));
    break;
  ...
  do_qemu_ldst:
    ...
    case 2:
      tci_args_rrm(insn, &r0, &r1, &oi);
      info->fprintf_func(info->stream, "%-12s  %s, %s, %x", op_name, str_r(r0),
                         str_r(r1), oi);
      break;
    case 3:
      tci_args_rrrr(insn, &r0, &r1, &r2, &r3);
    ...
    case 4:
      tci_args_rrrrr(insn, &r0, &r1, &r2, &r3, &r4);
      info->fprintf_func(info->stream, "%-12s  %s, %s, %s, %s, %s", op_name,
                         str_r(r0), str_r(r1), str_r(r2), str_r(r3), str_r(r4));
      break;
    default:
      g_assert_not_reached();
